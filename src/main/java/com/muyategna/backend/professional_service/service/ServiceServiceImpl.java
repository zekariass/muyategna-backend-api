...
public class ServiceServiceImpl implements ServiceService {
    ...
    @Autowired
    public ServiceServiceImpl(ServiceRepository serviceRepository, ServiceCountryAvailabilityService serviceCountryAvailabilityService, LanguageService languageService, ServiceTranslationRepository serviceTranslationRepository) {
...
//                .toList();
        ...
        List<ServiceLocalizedDto> localizedDtoList = getServiceLocalizedDtoList(pagedServicesContent);
    ...
    public List<ServiceLocalizedDto> getServicesByNameForCurrentCountry(String serviceName) {
        ...
        List<ServiceLocalizedDto> localizedDtoList = getServiceLocalizedDtoList(services);
